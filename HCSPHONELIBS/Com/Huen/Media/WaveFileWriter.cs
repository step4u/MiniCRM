...
namespace Com.Huen.Media
{
    public class WaveFileWriter : Stream
    {
        ...
        /// <summary>
        /// Append a new WaveFileWriter
        /// </summary>
        /// <param name="filename">The filename to write to</param>
        /// <param name="format">The Wave Format of the output data</param>
        public WaveFileWriter(string filename, WaveFormat format, FileMode filemode)
            : this(new FileStream(filename, filemode, FileAccess.Write, FileShare.Read), format)
        {
            this.filename = filename;
        }
